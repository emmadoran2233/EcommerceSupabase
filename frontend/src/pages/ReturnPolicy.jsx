      ...
      <div className="bg-white max-w-2xl w-full rounded-xl p-6 overflow-y-auto max-h-[80vh]">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li className="text-xl">
            For new unused items must be unused, unworn, and in their original
            packaging.
          </li>
          <li className="text-xl">
          ...
          <li className="text-xl">
            Certain items (e.g., clearance, personalized, or final-sale
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li className="text-xl">
            Buyers are responsible for return shipping costs unless the article
            sent is defect or wrong item sent.
          </li>
          <li className="text-xl">
            Use a trackable service or insurance; we can’t guarantee receipt
            without it.
          </li>
          <li className="text-xl">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li className="text-xl">
            We’ll inspect your return and notify you of approval/rejection.
          </li>
          <li className="text-xl">
        ...
        <p className="text-xl">
          Exchanges may be offered if stock is available. Buyers are responsible
        ...
        <p className="text-xl">
          If you receive a <strong>defective or incorrect</strong> item, contact
          us within <strong>7 days</strong> of delivery at{" "}
          <a className="underline" href="mailto:support@email.com">
            contact@ReShareLoop.com
          </a>
